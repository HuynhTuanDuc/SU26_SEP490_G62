...
const uploadCompanyQr                  = makeUploader(UPLOAD.FOLDERS.COMPANY_QR);
const uploadReceiptCollectionProof     = makeUploader(UPLOAD.FOLDERS.RECEIPT_COLLECTION_PROOF);
const uploadPaymentVoucher             = makeUploader(UPLOAD.FOLDERS.PAYMENT_VOUCHER);
...
module.exports = { uploadProof, uploadReceipt, uploadPaymentReceipt, uploadIncident, uploadAvatar, uploadExpense, uploadMaintenanceBill, uploadTripComplete, uploadDebtRepayment, uploadCashCollectionReceipt, uploadCompanyQr, uploadReceiptCollectionProof, uploadPaymentVoucher };
